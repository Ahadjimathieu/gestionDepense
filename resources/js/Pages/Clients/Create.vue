                    ...
                    <form class="row g-3" @submit.prevent="store">
                        ...
                        <div class="col-4">
                            ...
                            <input v-model="form.telephone" :class="{ 'is-invalid': errors.telephone }" type="number"
                                class="form-control" id="inputFirstname" max="11">
                        </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form>
                                    <div id="example1_filter" style="float:right;" class="dataTables_filter">
                                        <label>Search:<input type="text" v-model="filters.search"
                                                class="form-control form-control-sm" name="search"
                                                @input="fetchClients" placeholder="" aria-controls="example1"></label>
                                    </div>
                                </form>
                                    ...
                                    <tbody>
                                        <tr v-for="client in clients.data" :key="client.id" class="">
                                            ...
                                            <td class="text-center">
                                                {{ moment(client . created_at) . format('DD-MM-YYYY') }}</td>
                                            <td class="text-center">
