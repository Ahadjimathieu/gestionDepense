...
class PdfController extends Controller
{
    ...
    public function getPdf(){
        ...
        try{
            ...
            return redirect('/facture')->with('error', $e->getMessage());
        }
    }
    ...
    public function convert_orders_data_to_html()
    {
        ...
        $output='<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" />
